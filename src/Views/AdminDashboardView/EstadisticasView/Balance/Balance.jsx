...
const Widget = ({ type }) => {
  ...
  const amount = getDynamicValue(type, users)
  ...
  switch (type) {
      ...
      data = {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className={`bi bi-person-fill ${style.icon}`}
            viewBox="0 0 16 16"
            style={{
              color: 'crimson',
    ...
    case 'order':
      data = {
        title: 'N° TOTAL DE LIBROS',
        isMoney: false,
        link: 'Todas los libros',
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            className={`bi bi-cart-check-fill ${style.icon}`}
            viewBox="0 0 16 16"
            style={{
              color: 'goldenrod',
      ...
      data = {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className={`bi bi-coin  ${style.icon}`}
            viewBox="0 0 16 16"
            style={{
              color: 'green',
      ...
      data = {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className={`bi bi-bar-chart-fill ${style.icon}`}
            viewBox="0 0 16 16"
            style={{
              color: 'purple',
