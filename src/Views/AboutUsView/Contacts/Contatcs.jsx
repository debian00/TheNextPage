      ...
      <div className={style.cont}>
        <div className={style.info}>
          ...
          <div className={style.parrafo}>
            <p>
              En <span>The Next Page</span>, estamos aquí para brindarte toda la
              asistencia que requieras. Si tienes consultas acerca de un libro
              en particular, necesitas asistencia con la selección de libros o
              simplemente deseas conocer más sobre nosotros, no dudes en ponerte
              en contacto con nosotros. Estamos a tu disposición para ayudarte
              en lo que necesites.
            </p>
          </div>
        ...
        <form
          ...
          className={`${style['row-cols-1']} ${style['custom-container']} ${
            style['formulario-entrada']
